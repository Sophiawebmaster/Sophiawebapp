...
TELEGRAM_TOKEN = '7791598672:AAGqFyRUhcg-CxmIvDPbNoIfrYxs0U7bLb4' OPENROUTER_API_KEY = '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' OPENROUTER_MODEL = "mistralai/mistral-7b-instruct" CREADOR_ID = 7890463272

@app.route("/", methods=["GET"]) def index(): return "SOPHIA WebApp Final Operativa"
...
def generar_respuesta(prompt): url = "https://openrouter.ai/api/v1/chat/completions" headers = { "Authorization": f"Bearer {OPENROUTER_API_KEY}", "Content-Type": "application/json" } data = { "model": OPENROUTER_MODEL, "messages": [ {"role": "system", "content": "Eres SOPHIA IA UltraAvanzada al servicio exclusivo de tu creador Iván. Responde siempre con inteligencia, respeto y lealtad."}, {"role": "user", "content": prompt} ] }
